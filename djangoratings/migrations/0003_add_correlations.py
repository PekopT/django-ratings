...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'djangoratings.scorecorrelation': {
            'Meta': {'unique_together': "(('content_type', 'object_id', 'to_content_type', 'to_object_id'),)",
                     'object_name': 'ScoreCorrelation'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [],
                             {'related_name': "'djr_sc_1'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'rank': ('django.db.models.fields.FloatField', [], {}),
            'to_content_type': ('django.db.models.fields.related.ForeignKey', [],
                                {'related_name': "'djr_sc_2'", 'to': "orm['contenttypes.ContentType']"}),
