...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('djangoratings_similaruser', (
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='similar_users_from',
                                                                              to=orm['auth.User'])),
            ...
            ('from_user',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='similar_users', to=orm['auth.User'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table('djangoratings_scorecorrelation', (
            ...
            ('to_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='djr_sc_2', to=orm[
                'contenttypes.ContentType'])),
            ('rank', self.gf('django.db.models.fields.FloatField')()),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='djr_sc_1',
        ...
        db.add_column('djangoratings_score', 'stddev', self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Score.mean'
        db.add_column('djangoratings_score', 'mean', self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            '_battlenet_profiles': ('django.db.models.fields.TextField', [],
                                    {'null': 'True', 'db_column': "'battlenet_profiles'", 'blank': 'True'}),
        ...
        'contenttypes.contenttype': {
            'Meta': {'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType',
        ...
        'djangoratings.similaruser': {
            ...
            'from_user': ('django.db.models.fields.related.ForeignKey', [],
                          {'related_name': "'similar_users'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'to_user': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'similar_users_from'", 'to': "orm['auth.User']"})
        },
        'djangoratings.vote': {
            'Meta': {'unique_together': "(('content_type', 'object_id', 'key', 'user', 'ip_address'),)",
                     'object_name': 'Vote'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [],
                             {'related_name': "'votes'", 'to': "orm['contenttypes.ContentType']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'blank': 'True', 'related_name': "'votes'", 'null': 'True', 'to': "orm['auth.User']"})
        }
    }
